...
### US-006: Remove schedule section from Burn Squad settings panel
**Description:** As a squad admin, the settings panel no longer duplicates schedule editing since the inline experience is the primary way to manage it. *(Note: Per requirements, schedule editing remains in both places.)*

**This story is intentionally excluded** — schedule editing stays in the settings panel per the product decision.
