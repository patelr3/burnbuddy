      ...
      <main className="mx-auto max-w-xl px-4 pt-6 pb-12">
        <div className="mb-6 flex items-center justify-between">
          ...
          <button
            ...
            className="btn-primary-gradient cursor-pointer rounded-lg px-4 py-2 text-sm font-semibold text-white"
          >
            + Add Friend
          </button>
        </div>
            ...
            <div className="mx-4 w-full max-w-sm rounded-lg border border-gray-700 bg-surface p-6">
              ...
              <div className="flex justify-end gap-2">
                ...
                <button
                  ...
                  className="btn-primary-gradient cursor-pointer rounded-md px-4 py-2 text-sm font-medium text-white disabled:opacity-50"
                >
